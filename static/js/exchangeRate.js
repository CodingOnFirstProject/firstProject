...
function showResult(){
  ...
  // console.log('선택국1', selectCountry.value);
  // console.log('선택국2', seeCountry.value);

  //   const temp = selectCountry.value;
  //   selectCountry.value = seeCountry.value;
  //   seeCountry.value = temp; 
    calculate();
}